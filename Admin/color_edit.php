...
if(isset($_POST['save'])){
    ...
    $sql1 = "UPDATE COLOR SET C_COLOR = '$color' WHERE C_ID = $id";
...
?>
     ...
     <div class="main" id="main">
        <div class="container-fluid px-4">
            ...
            <?php
                $sql = "SELECT * FROM COLOR WHERE C_ID = $id";
            ...
            <form action="" class="p-3 mt-5" method="post">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" disabled value="<?php echo $data['C_ID']; ?>" name="c_id" class="form-control" >
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Color</label>
                    <div class="col-sm-10">
                    <input type="text" value="<?php echo $data['C_COLOR']; ?>" name="color" class="form-control" >
                    </div>
                </div>
